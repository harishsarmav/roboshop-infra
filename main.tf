...
module "rds" {
  source              = "github.com/harishsarmav/tf-module-rds"
  env                 = var.env
...
module "elasticache" {
  source              = "github.com/harishsarmav/tf-module-elasticache"
  env                 = var.env
...
module "rabbitmq" {
  source              = "github.com/harishsarmav/tf-module-rabbitmq"
  env                 = var.env
...
module "alb" {
  source              = "github.com/harishsarmav/tf-module-alb"
  env                 = var.env
